<footer class="p-4 bg-white sm:p-6 mt-auto">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center">© 2022 <a href="/" class="hover:underline">BookI™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.linkedin.com/in/bogomil-dochev/" target="_blank" class="text-gray-500 hover:text-gray-900">
            ...
            <a href="https://github.com/BogomilDochev" target="_blank" class="text-gray-500 hover:text-gray-900">
