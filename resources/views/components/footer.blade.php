<footer class="p-4 bg-white sm:p-6 mt-auto">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.linkedin.com/in/bogomil-dochev/" class="text-gray-500 hover:text-gray-900">
            ...
            <a href="https://github.com/BogomilDochev" class="text-gray-500 hover:text-gray-900">
